...
def pMotion_page():
    st.markdown(
        ...
        <style>
            ...
            .stApp {
                background-image: url("https://static.vecteezy.com/system/resources/thumbnails/037/170/421/small_2x/ai-generated-a-gym-with-dark-exercise-equipment-free-photo.jpg");
